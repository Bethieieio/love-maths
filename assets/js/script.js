...
/**
 * gets the operends (the numbers) and the operator (plus, minus etc)
...
function calculateCorrectAnswer() {
  ...
  if (operator === "+") {
      ...
      throw `Unplimented operator ${operator}. Aborting!`;
  }
 ...
 */
 function incrementScore() {
    ...
    let oneScore = parseInt(document.getElementById("score").innerText);
